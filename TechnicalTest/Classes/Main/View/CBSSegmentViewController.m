...
- (void)initViewController:(NSInteger)index
{
    if ([self.isFinishedArray[index] integerValue] == 0) {
        ...
        [viewController.view setFrame:CGRectMake(self.width*index, 20, self.width, self.height - self.cbs_buttonHeight)];
...
{
    self.headerView.frame = CGRectMake(0, 20, self.width, self.cbs_buttonHeight);
    ...
    if (titleArray.count == 3) {
        UILabel *line1 = [[UILabel alloc] initWithFrame:CGRectMake(self.cbs_buttonWidth - 0.5, 6, 1, self.cbs_buttonHeight-12-self.cbs_lineHeight)];
        line1.backgroundColor = self.cbs_titleColor;
        UILabel *line2 = [[UILabel alloc] initWithFrame:CGRectMake(self.cbs_buttonWidth*2 - 0.5, 6, 1, self.cbs_buttonHeight-12-self.cbs_lineHeight)];
        line2.backgroundColor = self.cbs_titleColor;
